...
namespace Tyuiu.BilousEYu.Sprint7.Project.V9
{
    public partial class FormMain : Form
    {
        ...
        public FormMain()
        {
            ...
            videoControl.MediaPlayer = _mediaPlayer; // videoControl - это элемент управления для отображения видео (например, VlcMediaPlayer)
        ...
        private void PlayVideo(string path)
        {
            ...
            {
                MessageBox.Show($"Ошибка при воспроизведении видео: {ex.Message}", "Ошибка", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
